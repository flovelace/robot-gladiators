var fightOrSkip = function () {
  ...
  if (promptFight === "skip") {
    // confirm the player wishes to skip
...
var fight = function(enemy) {
  ...
  while (playerInfo.health > 0 && enemy.health > 0) {
    // ask player if they would like to use fight or skip using fightOrSkip function
      if (fightOrSkip()) {
...
// function to generate a random numeric valuge
...
var endGame = function() {
  ...
  if (playerInfo.health > 0) {
    window.alert("Great job, you've surived the game! You now have a score of " + playerInfo.money + ".");
  }
  else {
...
var shop = function() {
  ...
  var shopOptionPrompt = window.prompt(
    "Would you like to REFILL your health, UPGRADE your attack, or LEAVE the shop? Please enter 1 for 'REFILL', 2 for 'UPGRADE', or 3 to 'LEAVE' to make a choice."
  );
...
var playerInfo = {
  ...
  refillHealth: function() {
    if (this.money >= 7) {
      window.alert("Refilling player's health by 20 for 7 bucks.");
      this.health += 20;
      this.money -= 7;
    }
    else {
  ...
  upgradeAttack: function() {
    if (this.money >= 7) {
      window.alert("Upgrading player's attack by 6 for 7 bucks.");
      this.attack += 6;
      this.money -= 7;
    }
    else {
...
var enemyInfo = [
  {
    name: "The Robotic Richard Simmons",
